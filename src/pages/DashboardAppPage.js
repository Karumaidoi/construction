...
export default function DashboardAppPage() {
  ...
  return (
    <>
      <Helmet>
        <title> Dashboard | Construction Portal </title>
      </Helmet>
      ...
      <Container maxWidth="xl">
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={6} md={3}>
            <AppWidgetSummary title="All Projects" total={books?.length ?? 3} icon={'ant-design:paper-clip-outlined'} />
          </Grid>
          ...
          <Grid item xs={12} md={6} lg={4}>
            <AppCurrentVisits
              title="Bids Summary"
              chartData={[
                { label: 'Weekly Bids', value: recentBids?.length ?? 0 },
                { label: 'Active Bids', value: activeBids?.length ?? 0 },
                { label: 'Declined Bids', value: declinedBids?.length ?? 0 },
                { label: 'All Projects', value: books?.length ?? 0 },
              ]}
              chartColors={[
